...
import {IERC165, IERC1155, IERC1155MetadataURI, IERC1155InventoryBurnable, ERC1155InventoryBurnable} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC1155/ERC1155InventoryBurnable.sol";
import {IERC1155InventoryMintable} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC1155/IERC1155InventoryMintable.sol";
    ...
    MinterRole
{
    ...
    function creator(uint256 collectionId)
        external
        view
        override
        returns (address)
    ...
    function safeMint(
        ...
        console.log("AJUNGE PANA IN safemint");
    ...
    function _msgSender()
        ...
        view
        virtual
        override(ManagedIdentity, UsingUniversalForwarding)
